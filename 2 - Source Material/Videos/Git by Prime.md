...
## Conflicts
**PAUSED**
conflicts happens when some changes happens on the same line on the same time, when one commit is the parent of the other, git doesn't know how to do so we need to help it figure
